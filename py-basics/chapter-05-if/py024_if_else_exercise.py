#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 17/10/27 上午11:11
# @Author  : Aries
# @Site    : 
# @File    : py24_if_else_exercise.py
# @Software: PyCharm
# if else 练习
...
favorite_fruits = ['apple', 'red date', 'melon']
